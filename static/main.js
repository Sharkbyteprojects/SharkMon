  ...
  $(document).ready(() => {
    $.get(
      ...
      (data) => {
        ...
        $("td.os").html(
          `<li>Arch: ${data.arch}</li><li>Homedir: ${data.homedir}</li><li>Hostname: ${data.hostname}</li><li>Release of OS: ${data.codename}</li><li>Temp Dir: ${data.tmpdir}</li><li>OS Uptime at page Load: ${data.osuptime}</li><li>OS Name: ${data.os}</li>`
        );
